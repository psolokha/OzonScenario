...
public class DriverController {
    ...
    private DriverController() {
        ...
        driver.manage().timeouts().setScriptTimeout(Integer.parseInt(properties.getProperty("timeouts.scriptTimeout")), TimeUnit.SECONDS);
        driver.manage().window().maximize();
        driver.get(properties.getProperty("url"));
        new WebDriverWait(driver, 20).ignoring(WebDriverException.class).until(driver -> {
